...
<script runat="server">
    ...
    string xmlFileName = "network.xml";
    string xmlFileCache = "SAnetworkXml";
    string entryName = "entry";
    string xmlSortBy = "EncoderName";
    string[] elements = new string[] { "EncoderName", "HostName", "IP", "ExternalInternal" };
...
<table width="100%" cellpadding="0" cellspacing="10">
    <tr>
        ...
        <td><img src="picts/empty.gif" width="30" height="10" border="0"/></td>
        <td>
            <span style="font-size:13px;font-weight:bold">External Network Settings:</span><br /><br />
            <b>Subnet Mask:</b> 255.255.255.192<br />
            <b>Default Gateway:</b>  193.109.49.65<br />
            <b>DNS1:</b> 154.15.254.138(193.109.48.159)<br />
            <b>DNS2:</b> 154.15.254.134(193.109.49.212)<br />
<br /><br /><br /><br />
            <span style="font-size:13px;font-weight:bold">Internal Network Settings:</span><br /><br />
            <b>Subnet Mask:</b> 255.255.255.0<br />
            <b>Default Gateway:</b>  192.168.2.1<br />
            <b>DNS1:</b> 192.168.2.8<br />
            <b>DNS2:</b> 192.168.2.9<br />
         </td>
    </tr>
</table>
